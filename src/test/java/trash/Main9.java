...
//
//        @Override
//        public void onMouseDrag(int initialDragPointX, int initialDragPointY, int deltaX, int deltaY) {
//
//            var theSelectedShape = findSelected(new Point(initialDragPointX + deltaX, initialDragPointY + deltaY));
//            if (theSelectedShape == null) {
//                // MODIFY THE OFFSET OF ALL THE DRAWING
//                offsetX += deltaX / zoom;
//                offsetY += deltaY / zoom;
//            } else {
//                // MOVE THE SELECTED ENTITY
//                theSelectedShape.getRectange().translate(deltaX, deltaY);
//            }
//            repaint();
//        }
//
...
//        }
//
//        Shape findSelected(Point2D mousePos) {
//            if (mousePos != null) {
//                for (var shape : shapes) {
...
//
//    void onMouseDrag(int initialDragPointX, int initialDragPointY, int deltaX, int deltaY);
//
...
//            initialDragPoint = lastDragPoint = e.getPoint();
//        } else {
